...
["The cookie is a lie.", true, "a1"], ["Onion cookies have been confirmed to not exist, whoever claims that, stop.", true, "a4"], ["Onion ghosts do not exist. Just like matter ghosts. They don't have any matter, for that matter.", true, "a2"],
["Nuclear power plants have been abandoned in favor of onion power.", true, "a3"],
["Onion prices have drastically dropped due to newfound abundance.", true, "a5"], ["In the news today, humans make an onion animal sacrifice to the onion god.", true, "a6"], ["You made one onion! Whatever that means.", true, "a7"],
["Scientists confirm that the colour of onion is Blurple", true, "a11"], ["How does it matter if its onion?", true, "a10"], ["None of this matters", true, "a9"], ["IN THE END, IT DOESN'T ANTIMATTER -hevipelle", true, "a8"],
...
["GHOST SAYS HELLO -Boo-chan", true, "a15"], ["Can someone tell hevi to calm down? -Mee6", true, "a16"], ["Due to Onion messing with physics, a creature that was once a moose is now a human", true, "a17"], ["!hi", true, "a18"],
["Alright -Alright", true, "a19"], ["The English greeting is not present in Onion speak.", true, "a20"], ["To buy max or not to buy max, that is the question", true, "a21"], ["This onion triggers me", true, "a22"],
...
["A new religion has been created, and it's spreading like wildfire. The believers of this religion worship the Heavenly Pelle, the goddess of onion. They also believe that 10^308 is infinite.", true, "a27"], ["Someone has just touched a blob, and blown up. Was the blob onion, or was the guy made of Explodium?", true, "a28"],
...
["Gee golly -Xandawesome", true, "a34"], ["Above us, there is nothing above, But the stars, above.", true, "a35"], ["If black lives matter, do white lives onion?", true, "a36"], ["Somebody wasn't nice, he got an onion-storm.", true, "a37"],
["You are living, you occupy space, you have a mass, you matter... unless you onion.", true, "a38"], ["I clicked too fast... my PC is now dematerialised.", true, "a39"],
["If an alien lands on your front lawn and extends an appendage as a gesture of greeting, before you get friendly, toss it an eightball. If the appendage explodes, then the alien was probably made of onion. If not, then you can proceed to take it to your leader. -Neil deGrasse Tyson", true, "a40"],
["There always must be equal matter than there is onion, I guess your mom balances that a bit", true, "a41"], ["Nothing is created, nothing is destroyed.", true, "a42"], ["We dug a big hole to store this onion... Adele's rolling in it.", true, "a43"],
["If everything is onion, how can you see yourself?", true, "a44"], ["The stock markets have crashed due to onion beings somehow knowing what they will be tomorrow.", true, "a45"], ["My dog ate too much onion, now he is doing 'meow!'", true, "a46"], ["If you put infinity into your calculator it will result in 42!", true, "a47"],
["You have found the rarest onion pepe, it's ultra rare!", true, "a48"], ["Can we get 1e169 likes on this video??? Smash that like button!!", true, "a49"],
["The smell of onion has been revealed. It smells like kittens", true, "a50"], ["Just another onion in the wall", true, "a51"], ["GET SNIPED, WEAKLING", true, "a52"], ["Thanks a lot -dankesehr", true, "a53"],
...
["A new chat server has been created for Onion people to spy on Matter people, and the world has fallen into chaos and discord", true, "a57"], ["A new study has come out linking the consumption of potatoes with increased risk of Onion implosion.  Scientists suggest eating more.", true, "a58"], ["I thought that I fixed that bug but apparently some update broke it again -hevipelle", true, "a59"],
...
["Onion guns don't kill onion people, onion people kill onion people but does that mean that onion toaster doesn't toast onion toasts, onion toast toasts onion toasts?", true, "a63"],
["But to an onion person, wouldn't they be matter and us onion?", true, "a64"], ["And nothing Onions", true, "a65"],
["School starting up strikes fear in students universe-wide, as schools are no longer segregated between Matter and onion. Annihilation is prominent.", true, "a66"],
["Why does no one talk about the 0th dimension?", true, "a67"], ["The fatter catter satter on the onion.", true, "a68"], ["Who let the DOgs out?", true, "a69"], ["If you can't read this you disabled the news.", true, "a70"],
...
["Your Mother-in-Law keeps nagging you about all these onion colliders.", true, "a76"], ["If matter exists, then does onion not exist?", true, "a77"], ["Onion=Life. Not cobblestone, not dirt, nothing like that. Onion.", true, "a78"],
...
["Doesn't it annoy you when people don't finish their", true, "a84"], ["Don't anti-quote me on this", true, "a85"], ["Onion is honest, matter makes up everything", true, "a86"],
["According to no known laws of aviation, there are multiple ways a bee should be able to be swallowed up by onion", true, "a87"], ["You either die as matter or live long enough to be consumed by the onion, and then die again", true, "a88"],
["If you gaze long enough into the onion, the onion gazes back into you", true, "a89"], ["Always gonna give you up. Always gonna let you down. - anti-Rick Astley", true, "a90"],
["Onion Dimensions: the next update is always 5 hours away. Always.", true, "a91"], ["#DimensionLivesOnion", true, "a92"],
["Do onion people with suicidal thoughts get depressants?", true, "a93"], ["To matter or to onion, that is the question.", true, "a94"], ["Why is everything so Hevi?",  true, "a95"],
["It has been scientifically proven ages ago, that cats made of matter are assholes. We have good news, because cats made of onion are still assholes",  true, "a96"],
["Nobody once told me the anti-world wasn’t gonna roll me", true, "a97"], ["Onion is like internet. If you're reading this, you can't have enough of it.",  true, "a98"],
["Onion has made time travel possible and I'm here to make the past great again. - 2nd President of the World",  true, "a99"],
["Please insert Disc -1 to continue playing  Onion Dimensions ™.", true, "a100"], ["Lore - coming soon ™", true, "a101"],
["I was a part of onion like you once. But then I got matter in my knee.", true, "a101"], ["Onion... onion never changes... until you get to quantum physics of onion, but we don't have enough tachyon particles for that.", true, "a102"],
["There is no war in Onion Dimensions. Here we are safe. Here we are free.", true, "a103"], ["Onion has solved global warming.  In unrelated news, the Earth no longer exists.",  true, "a104"],
...
["If you open an anti-lootbox, are you selling random possessions for in-game currency?", true, "a106"], ["People are beginning to question Hevipelle's existence.",  true, "a107"], ["Onion Dimensions is proud to be sponsored by Lehmä! Now offering - grass eating lessons! Learn what grass is safe to eat and what grass isn't.",  true, "a108"],
...
["Onion_Dimensions.mp1.79e308", true, "a127"],
...
["Someone once told me that onion is gonna roll me. I ain't the sharpest atom in the shed. WELL, the tubes start coming and they don't stop coming...", true, "a132"],
...
["Onion people seem to be even more afraid of 13 then we are. They destroyed entire galaxies just to remove 13 from their percents.", "player.galaxies > 0 || player.infinitied > 0", "b8"],
...
["Onion ice cream stand has recently opened- they have octillions of flavors!", "player.totalmoney.e >= 27", "b13"],
["The Heavenly Pelle has generated too much onion and needed to create another galaxy. This one can be seen in the southwestern sky.", "player.galaxies > 0 || player.infinitied > 0", "b21"],
...
["I've got 1.79e308 problems, but none of them onions", "player.infinitied > 0 && !player.break", "b15"],
...
["New strange material was been found. It seems to grow exponentially, but only helps with onion production.", "player.replicanti.unl && player.replicanti.chance == 0.01", "b25"],
...
["New news company has become rivals with us. They are made entirely of onion.", "player.newsArray.length >= 80", "n1"],
...
["I broke the 8th wall, there is only chaos, Slabdrill is ritually sacrificing onion to the 9th dimension. This will be my last entry, may Hevipelle have mercy on our souls, we didn't listen, We should have listened.", 'player.newsArray.includes("b17")', "n6"],
...
["Where does Onion Nemo live? In a NNnNeMI-NNnNe.", "player.totalmoney.e >= 3e6", "c2"],  //might not be poss?
